...
StatusType RecordsCompany::putOnTop(int r_id1, int r_id2) {
    ...
    try {
        Record* B = _records.ReturnObject(r_id1);
        Record* A = _records.ReturnObject(r_id2);
...
StatusType RecordsCompany::getPlace(int r_id, int *column, int *hight) {
    ...
    try {
        *hight = _records.SumHeight(_records.ReturnObject(r_id));
